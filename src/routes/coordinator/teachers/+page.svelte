  ...
  <div class="content-wrapper">
    <section class="report-action-card">
      <div>
        ...
        <h2>{t('pages.coordinatorTeachers.heading')}</h2>
        <p>{t('pages.coordinatorTeachers.description')}</p>
      </div>
    ...
    <CoordinatorUsersDataTable
      ...
      subtitle={t('pages.coordinatorTeachers.tableSubtitle')}
      searchPlaceholder={t('pages.coordinatorTeachers.searchPlaceholder')}
      emptyMessage={t('pages.coordinatorTeachers.emptyMessage')}
      userType="teachers"
    />
  </div>
</main>
