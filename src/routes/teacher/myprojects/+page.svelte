<script>
  ...
  $: stats = [
    {
      label: t('pages.teacherMyProjects.heading'),
  ...
  <div class="content-wrapper">
    <header class="main-header">
      <div>
        ...
        <h1>{t('pages.teacherMyProjects.heading')}</h1>
        <p>{t('pages.teacherMyProjects.description')}</p>
      </div>

      <div class="header-actions">
        <a class="report-btn" href="/teacher/myprojects/report" target="_blank" rel="noopener noreferrer">
          {t('pages.teacherMyProjects.pdfReport')}
        </a>

        <span class="header-label">{t('pages.teacherMyProjects.headerLabel')}</span>
      </div>
    </header>
    ...
    <ProjectCardsDataTable
      {rows}
      title={t('pages.teacherMyProjects.heading')}
      badgeColor="var(--sgpa-success)"
      emptyMessage={t('pages.teacherMyProjects.emptyMessage')}
      searchPlaceholder={t('pages.teacherMyProjects.searchPlaceholder')}
    />
  </div>
</main>
