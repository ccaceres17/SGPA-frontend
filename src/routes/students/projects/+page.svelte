  ...
  <div class="content-wrapper">
    <header class="main-header">
      <div>
        ...
        <h1>{t('pages.studentProjects.heading')}</h1>
        <p>{t('pages.studentProjects.description')}</p>
      </div>

      <div class="header-actions">
        <a class="report-btn" href="/students/projects/report" target="_blank" rel="noopener noreferrer">
          {t('pages.studentProjects.pdfReport')}
        </a>

        <span class="header-label">{t('pages.studentProjects.headerLabel')}</span>
      </div>
    </header>
    ...
    <ProjectCardsDataTable
      {rows}
      title={t('pages.studentProjects.heading')}
      badgeColor="var(--sgpa-blue)"
      emptyMessage={t('pages.studentProjects.emptyMessage')}
      searchPlaceholder={t('pages.studentProjects.searchPlaceholder')}
    />
  </div>
</main>
