<script>
  ...
  const workspaceItems = [
    { nameKey: 'sidebar.mainPanel', href: '/teacher', icon: 'list' },
    { nameKey: 'sidebar.availableProjects', href: '/teacher/projects', icon: 'search' },
    { nameKey: 'sidebar.myProjects', href: '/teacher/myprojects', icon: 'folder' }
  ];

  const accountItems = [
    { nameKey: 'sidebar.profile', href: '/teacher/profile', icon: 'user' },
    { nameKey: 'sidebar.availability', href: '/teacher/availability', icon: 'calendar' }
  ];
...
<aside class="sidebar" class:open={isOpen}>
  <div class="sidebar-header">
    ...
    <div>
      <h2>SGPA</h2>
      <p>{t('sidebar.teacherModuleLabel')}</p>
    </div>
  </div>

  <nav class="menu" aria-label={t('sidebar.teacherModuleLabel')}>
