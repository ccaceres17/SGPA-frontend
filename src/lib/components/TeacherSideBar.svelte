<script>
  ...
  const workspaceItems = [
    { nameKey: 'sidebar.mainPanel', href: '/teacher' },
    { nameKey: 'sidebar.availableProjects', href: '/teacher/projects' },
    { nameKey: 'sidebar.myProjects', href: '/teacher/myprojects' }
  ];

  const accountItems = [{ nameKey: 'sidebar.profile', href: '/teacher/profile' }];
